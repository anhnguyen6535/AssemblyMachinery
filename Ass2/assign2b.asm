...
initialize:
	...
	mov	x_r,0x7F80					// initializes x with 0x7F80
	lsl	x_r,x_r,12					// shifts 3 numbers in hex 
	add	x_r,x_r,0x7F8					// adds 7F8 to the end of x
	lsl	x_r,x_r,4					// adds 0 at the end to make x = 0x7F807F80
